...
docker-compose -f docker-compose.yml -f docker-compose.prod.yml exec backend sh -c 'python3 manage.py dumpdata > /match4healthcare-backend/backups/fixture-$(date +%F_%H%M%S).json'
