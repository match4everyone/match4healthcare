...
def send_mass_mail_sendgrid(recipient_list, subject, html_body,
    ...
    if response.status_code != 202:
        logger.error('A newsletter could not be delivered, the sendgrid API did not queue them.',
                        extra={
