...
class BaseEvaluation(models.Model):
    overall_rating = models.IntegerField(
        choices=QUALITY_CHOICES, default=AVERAGE, blank=False, null=False
    )
    ...
    likelihood_recommendation = models.IntegerField(
        choices=RECOMMENDATION_CHOICES, default=AVERAGE, blank=False, null=False
    )
...
class InstitutionEvaluation(BaseEvaluation):
    ...
    institution_type = models.CharField(
        max_length=30, choices=INSTITUTION_CHOICES, default=INSTITUTION_HOSPITAL
    )
