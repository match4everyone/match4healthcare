...
class UrlEndpointTestCase(TestCase):
    ...
    def test_http_get_endpoints(self):
        assert self.client.get('/de/', {}).status_code == 200
        assert self.client.get('/de/about/', {}).status_code == 200
        assert self.client.get('/de/impressum/', {}).status_code == 200
        assert self.client.get('/de/dataprotection/', {}).status_code == 200
        assert self.client.get('/de/legal-questions/', {}).status_code == 200

        # Mapview
        assert self.client.get('/de/mapview/', {}).status_code == 200

        # Accounts
        assert self.client.get('/de/accounts/signup_student', {}).status_code == 200
        assert self.client.get('/de/accounts/signup_hospital', {}).status_code == 200
        assert self.client.get('/de/accounts/password_reset/', {}).status_code == 200
        assert self.client.get('/de/accounts/login/', {}).status_code == 200

    def test_count_url(self):
        generate_random_student(validated_email=True)
        response = self.client.get('/de/accounts/count', {})
    ...
    def test_student(self):
        ...
        assert self.client.post('/de/accounts/logout/', {}).status_code == 200

        response = self.client.post('/de/accounts/password_reset', {
            "email": student_email
        }, follow=True)
        ...
        response = self.client.post('/de/accounts/validate_email', {
            "email": student_email
        }, follow=True)
        ...
        response = self.client.post('/de/accounts/login/', {
        ...
        response = self.client.post('/de/accounts/password_change', {
            "email": student_email,
        ...
        response = self.client.get('/de/accounts/profile_redirect', follow=True)
        assert "profile_student" in response.redirect_chain[0][0]
        assert self.client.get('/de/accounts/profile_student', {}).status_code == 200

        assert self.client.get('/de/accounts/logout/', {}).status_code == 200
        ...
        response = self.client.get("/de/ineedstudent/students/DE/14482/0", follow=True)
        assert "login" in response.redirect_chain[0][0]
        assert response.status_code == 200

        # Test admin view when logged in as student. Should redirect
        response = self.client.get("/de/accounts/approve_hospitals", follow=True)
        assert "login" in response.redirect_chain[0][0]
        assert response.status_code == 200
        ...
        response = self.client.get('/de/ineedstudent/hospital_view/' + str(uuid1) + "/")
        assert response.status_code == 200

        response = self.client.get('/de/ineedstudent/hospitals/DE/14482')
        assert response.status_code == 200

        assert self.client.get('/de/accounts/delete_me_ask', {}).status_code == 200
        assert self.client.get('/de/accounts/delete_me', {}).status_code == 200
        ...
        response = self.client.get('/de/ineedstudent/hospital_view/' + str(uuid1) + "/", follow=True)
        assert "login" in response.redirect_chain[0][0]
        assert response.status_code == 200

        # Only available to logged in users, should redirect
        response = self.client.get('/de/ineedstudent/hospitals/DE/14482', follow=True)
        assert "login" in response.redirect_chain[0][0]
        assert response.status_code == 200
    ...
    def test_hospital(self):
        ...
        assert self.client.get('/de/accounts/profile_hospital', {}).status_code == 200
        ...
        response = self.client.get('/de/ineedstudent/hospital_view/' + str(uuid) + "/")
        assert response.status_code == 200
        ...
        response = self.client.get('/de/ineedstudent/students/DE/14482/0')

        assert "1 Helfer*innen" in str(response.content)
        assert response.status_code == 200

        response = self.client.get('/de/ineedstudent/students/DE/14482/50')
        ...
        response = self.client.post('/de/ineedstudent/zustimmung', {
    ...
    def test_sudent_individual_view(self):
        ...
        response = self.client.get('/de/iamstudent/view_student/' + str(student_uuid), follow=True)
        assert response.status_code == 200
        ...
        response = self.client.get('/de/iamstudent/view_student/' + str(student_uuid))
        assert response.status_code == 200
